...
public class GUIInterfaceUDP extends JFrame implements MessageContainer {
    ...
    public GUIInterfaceUDP() {
        setTitle("Whatsapp 2.0 (UDP)");
        setSize(800, 500);
    ...
    private void attemptConnection() {
        try {
            ...
            chatSender = ChatFactory.build(Protocol.UDP, "localhost", remote, local, this);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(GUIInterfaceUDP::new);
    }
}